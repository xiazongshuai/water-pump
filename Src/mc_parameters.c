...
//180W和550W板子的U、W两相采样相反
	
//550W板子
#if 0
	//ADC channel selection register  通道0 4 5对应U V W
  .ADCConfig = {
  ...
  .ADCScandir = {  //扫描方向 FORWARD:小-->大                 先  后
...
#if 1
  .ADCConfig = {
                ( uint32_t )( 1<< 4 ) | ( uint32_t )( 1<< 5 ), //4  5
                ( uint32_t )( 1<< 0 ) | ( uint32_t )( 1<< 5 ), //0  5
                ( uint32_t )( 1<< 0 ) | ( uint32_t )( 1<< 5 ), //0  5
                ( uint32_t )( 1<< 0 ) | ( uint32_t )( 1<< 4 ), //0  4
                ( uint32_t )( 1<< 0 ) | ( uint32_t )( 1<< 4 ), //0  4
                ( uint32_t )( 1<< 4 ) | ( uint32_t )( 1<< 5 ), //4  5
  },
  .ADCScandir = {  //扫描方向 FORWARD:小-->大                 先  后
