...
#define MAX_READABLE_CURRENT 3.3/(2*RSHUNT*AMPLIFICATION_GAIN)//3.3/(2*0.3*1.1)

const char_t CTL_BOARD[] = "NUCLEO-G071RB";
static const char_t M1_PWR_BOARD[] = "~v6_X-NUCLEO-IHM08M1_change_AOKU_HW";
...
{
  .maxMechanicalSpeed = 4000,//3600,//3200,
  .maxReadableCurrent = MAX_READABLE_CURRENT,
  .nominalCurrent = NOMINAL_CURRENT,//13900,//2978*3,//29785,
  .nominalVoltage = 310,//15,
