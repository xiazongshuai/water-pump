...
RevUpCtrl_Handle_t RevUpControlM1 =
{
  ...
  .OTFPhaseParams         = {(uint16_t)500,
                             ...
                             (void*)MC_NULL},
  .ParamsData             = {{(uint16_t)PHASE1_DURATION,(int16_t)(PHASE1_FINAL_SPEED_UNIT),PHASE1_FINAL_CURRENT,&RevUpControlM1.ParamsData[1]},  //Æô¶¯Îå½×¶Î
