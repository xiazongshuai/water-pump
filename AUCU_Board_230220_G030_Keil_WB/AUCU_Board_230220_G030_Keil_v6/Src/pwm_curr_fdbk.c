...
__weak uint16_t PWMC_SetPhaseVoltage(PWMC_Handle_t *pHandle, alphabeta_t Valfa_beta)
{
  ...
  else
  {
    ...
    pHandle->CntPhC = (uint16_t)(MAX(wTimePhC, 0));
		...
		//watch_data.my_w.W_CNT_A = pHandle->CntPhA;
		
//if( pHandle->CntPhA < DEAD_TIME_COUNTS)
//{
//	pHandle->CntPhA = 0;
//}
//if( pHandle->CntPhB < DEAD_TIME_COUNTS)
//{
//	pHandle->CntPhB = 0;
//}
//if( pHandle->CntPhC < DEAD_TIME_COUNTS)
//{
//	pHandle->CntPhC = 0;
//}


//if( pHandle->CntPhA > (int32_t)pHandle->PWMperiod/2-DEAD_TIME_COUNTS/2)
//{//printf("AX\r\n");
//	pHandle->CntPhA = (int32_t)pHandle->PWMperiod/2;
//}
//if( pHandle->CntPhB > (int32_t)pHandle->PWMperiod/2-DEAD_TIME_COUNTS/2)
//{//printf("bX\r\n");
//	pHandle->CntPhB = (int32_t)pHandle->PWMperiod/2;
//}
//if( pHandle->CntPhC > (int32_t)pHandle->PWMperiod/2-DEAD_TIME_COUNTS/2) //24
//{//printf("cX\r\n");
//	pHandle->CntPhC = (int32_t)pHandle->PWMperiod/2;
//}

//if( pHandle->CntPhA >= 1970)
//{//printf("AX\r\n");
//	pHandle->CntPhA = (int32_t)pHandle->PWMperiod/2;
//}
//if( pHandle->CntPhB  >= 1970)
//{//printf("bX\r\n");
//	pHandle->CntPhB = (int32_t)pHandle->PWMperiod/2;
//}
//if( pHandle->CntPhC  >= 1970) //24
//{//printf("cX\r\n");
//	pHandle->CntPhC = (int32_t)pHandle->PWMperiod/2;
//}

if(pHandle->CntPhA > pHandle->CntPhB && pHandle->CntPhA > test_max)
{
  test_max = pHandle->CntPhA;
	if(pHandle->CntPhC > test_max)
	{
	  test_max = pHandle->CntPhC;
	}
}
if(pHandle->CntPhB > pHandle->CntPhA && pHandle->CntPhB > test_max)
{
  test_max = pHandle->CntPhB;
	if(pHandle->CntPhC > test_max)
	{
	  test_max = pHandle->CntPhC;
	}
...
if( pHandle->CntPhC > test_max)
{
  test_max = pHandle->CntPhC;
    ...
    returnValue = pHandle->pFctSetADCSampPointSectX(pHandle); //R3_1_SetADCSampPointSectX
#ifdef NULL_PTR_PWR_CUR_FDB
  }
#endif
  return (returnValue);
