...
#define PWM_PERIOD_CYCLES (uint16_t)((ADV_TIM_CLK_MHz*(uint32_t)1000000u/((uint32_t)(PWM_FREQUENCY)))& ( uint16_t )0xFFFE)  //4000
...
#define MAX_MODULE 31783   //32767*0.97

#define SAMPLING_CYCLE_CORRECTION 0.5 /* Add half cycle required by STM32G030K8Tx ADC */
