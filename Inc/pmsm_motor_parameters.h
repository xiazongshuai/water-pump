...
#define POLE_PAIR_NUM          USER_POLE_PAIR_NUM//2/* Number of motor pole pairs */
#define RS                     USER_RS//32 /* Stator resistance , ohm*/
#define LS                     USER_LS//0.138 /* Stator inductance, H
...
#define NOMINAL_CURRENT         USER_NOMINAL_CURRENT//USER_CURRENT_1A*0.5
#define MOTOR_MAX_SPEED_RPM     USER_MAX_SPEED//4500 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  USER_KE//42.39//6.12//8.105//53.8 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                USER_ID_DEMAG//-USER_CURRENT_1A*0.5 /*!< Demagnetization current */
