...
#define  USER_IQMAX             (USER_CURRENT_1A*1.35*2/3)
...
#define  USER_RS         		  48.5 //32
#define  USER_LS         		  0.205 //0.41 //0.138
#define  USER_LD          		0.205 //0.41 //0.138
#define  USER_KE          		50.4 //75.66 //50.4 //42.39
#define  USER_POLE_PAIR_NUM   2 //3 //2
...
//10ºÁÅ· F1:16384   F2:4096  G1:-5257   G2:24185
//100ºÁÅ· F1:16384   F2:16384  G1:-5257   G2:9678
...
#define GAIN1                          -5256 //-5914 
#define GAIN2                          12902 //10740 //16122
/*Only in case PLL is used, PLL gains */
#define PLL_KP_GAIN                   299 //449
#define PLL_KI_GAIN                   13 //20
...
#define PID_TORQUE_KP_DEFAULT         2194/20  //2954/20 //2238/20
#define PID_TORQUE_KI_DEFAULT         2076/20 //2740/20 //2076/20
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2194/20 //2954/20 //2238/20
#define PID_FLUX_KI_DEFAULT           2076/20 //2740/20 //2076/20
#define PID_FLUX_KD_DEFAULT           100


/* Torque/Flux control loop gains dividers*/
#define TF_KPDIV                      8 //16 //4
#define TF_KIDIV                      512 //1024 //256
#define TF_KDDIV                      8192
#define TF_KPDIV_LOG                  LOG2((8)) //LOG2((16)) //LOG2((4))
#define TF_KIDIV_LOG                  LOG2((512)) //LOG2((1024)) //LOG2((256))
...
#define PID_SPEED_KP_DEFAULT        2438*8/(SPEED_UNIT/10) // 3657/(SPEED_UNIT/10) //2898/(SPEED_UNIT/10)  /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT        31*8/(SPEED_UNIT/10) // 47/(SPEED_UNIT/10) //37/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
