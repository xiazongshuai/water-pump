...
#define VBUS_PARTITIONING_FACTOR      0.0064932432432432 //0.007042253521126761 
                                                       /*!< It expresses how
                                                       much the Vbus is attenuated
                                                       before being converted into
                                                       digital value */
#define NOMINAL_BUS_VOLTAGE_V         310//15
/******** Current reading parameters section ******/
/*** Topology ***/
#define THREE_SHUNT

#define RSHUNT                       USER_RSHUNT// 0.01//0.3

/*  ICSs gains in case of isolated current sensors,
        amplification gain for shunts based sensing */
#define AMPLIFICATION_GAIN            USER_AMPLIFICATION_GAIN//10//1.1
