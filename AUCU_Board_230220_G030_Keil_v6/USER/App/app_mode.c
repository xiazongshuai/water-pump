...
档位1~6，每增加一档，转增加500，基础值为1000
档位7可通过0~10V电压调速，电压越高速度越慢
*******************************/
...
{ 
	...
	need_stop_flag = 1;
	MC_ProgramSpeedRampMotor1(1000/6,5000);
	MC_StartMotor1();
}
...
void mode_speed_init(void)
{
	...
	MC_ProgramSpeedRampMotor1(1500/6,5000);
	MC_StartMotor1();
...
void mode_pressure_7m_init(void)
{
	...
	MC_ProgramSpeedRampMotor1(2500/6,5000);
	MC_StartMotor1();
}
...
void mode_pressure_9m_init(void)
{
	...
	MC_ProgramSpeedRampMotor1(3000/6,5000);
	MC_StartMotor1();
}
...
void mode_max_power_12m_init(void)
{
	...
	need_stop_flag = 1;
	MC_ProgramSpeedRampMotor1(3500/6,5000);
	MC_StartMotor1();
}
